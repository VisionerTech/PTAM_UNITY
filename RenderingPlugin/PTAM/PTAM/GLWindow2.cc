...
void GLWindow2::SetupViewportVRLeft()
{
	//cout<<size()[0]<<" "<<size()[1]<<" "<<endl;
	glViewport(0, 0, size()[0]/2, size()[1]);
	//glViewport(280, 80, 720, 1280);
	//glViewport(-200, -200, 720, 1280);
	//glViewport(-50, -50, size()[0]/2+50, size()[1]+50);
}

void GLWindow2::SetupViewportVRRight()
{
	glViewport(size()[0]/2, 0, size()[0]/2, size()[1]);
	//glViewport(size()[0]/2-50, -50, size()[0]/2+50, size()[1]+50);
	//glViewport(1560	, 80, 720, 1280);
}
