...
struct MiniPatch
{
  ...
  //find path in stereo rectified image
  bool FindPatchRectify(CVD::ImageRef &irPos,  CVD::BasicImage<CVD::byte> &im, int nRange, std::vector<CVD::ImageRef> &vCorners);
  ...
  static int maxStereoSSD;		//max stereo 
