...
void EyeGame::DrawStuff(Vector<3> v3CameraPos, int left_right)
{
  if(!mbInitialised)
    Init();
  ...
  af[0]=0.0; af[1]=0.0; af[2]=1.0; af[3]=0.0;
 ...
 //     else
	//LookAt(i, v3CameraPos, 0.02 );
	  ...
	  //glMultMatrix(ase3WorldFromEye[0]);
...
void EyeGame::Reset()
{
  ...
  ase3WorldFromEye[0].get_translation()[2] = mdEyeRadius+0.4;
  ase3WorldFromEye[1].get_translation()[2] = mdEyeRadius+0.4;
  ase3WorldFromEye[2].get_translation()[2] = mdEyeRadius+0.4;
  ase3WorldFromEye[3].get_translation()[2] = mdEyeRadius+0.4;
