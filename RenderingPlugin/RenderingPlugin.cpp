...
//start SLAM
extern "C" void UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API start_slam()
{
	SLAM_ptr->requestStart();
}

//Reset SLAM
extern "C" void UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API reset_slam()
{
	SLAM_ptr->requestReset();
	cv::waitKey(500);
}

//get tracking quality
extern "C" int UNITY_INTERFACE_EXPORT UNITY_INTERFACE_API get_tracking_state()
{
	return SLAM_ptr->getTrackingQuality();;
}

//get model view translation
extern "C" UNITY_INTERFACE_EXPORT  double*  get_translation()
{
	return SLAM_ptr->getTranslation();
}

//get model view rotation
extern "C" UNITY_INTERFACE_EXPORT  double* get_rotation()
{
	return SLAM_ptr->getRotation();
}
