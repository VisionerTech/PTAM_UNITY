...
void Vector3Transform( Vector3 *pvec3Out, const Vector3 *pVec3In, const MMD_Matrix matTransform )
{
	Vector3	vec3Temp;
...
void Vector3Rotate( Vector3 *pvec3Out, const Vector3 *pVec3In, const MMD_Matrix matRotate )
{
	Vector3	vec3Temp;
...
void MatrixIdentity( MMD_Matrix matOut )
{
...
void MatrixRotationX( MMD_Matrix matOut, float fAngle )
{
	float	c = cosf( fAngle );
	float	s = sinf( fAngle );
...
void MatrixMultiply( MMD_Matrix matOut, const MMD_Matrix matSrc1, const MMD_Matrix matSrc2 )
{
	MMD_Matrix	matTemp;
	int		i;
...
void MatrixInverse( MMD_Matrix matOut, const MMD_Matrix matSrc )
{
	MMD_Matrix	matTemp;
	memcpy( matTemp, matSrc, sizeof(MMD_Matrix) );
...
void MatrixLerp( MMD_Matrix matOut, MMD_Matrix matSrc1, MMD_Matrix matSrc2, float fLerpValue )
{
...
void MatrixPlanarProjection( MMD_Matrix matOut, const Vector4 *pvec4Plane, const Vector3 *pvec3LightPos )
{
...
void QuaternionToMatrix( MMD_Matrix matOut, const Vector4 *pvec4Quat )
{
